...
\input{chapters/2-conceitos}
\input{chapters/3-revisao}
\input{chapters/4-modelo}
\input{chapters/5-desenvolvimento}
% \input{chapters/6-experimentos}
\input{chapters/conclusao_tcc1}
...
\begin{apendicesenv}
%	\partapendices*
	\input{aftertext/obdh_devices}
% 	\input{aftertext/analisador}
